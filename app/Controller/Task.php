...
class Task extends Base
{
    ...
    public function create()
    {
        ...
        $this->response->html($this->template->layout('task_new', array(
            ...
            'values' => array(
				...
				'release_id' => $this->request->getIntegerParam('release_id'),
			...
			'releases_list' => $this->release->getList($project_id),
            'date_format' => $this->config->get('application_date_format'),
            'date_formats' => $this->dateParser->getAvailableFormats(),
            'menu' => 'tasks',
            'title' => t('New task')
    ...
    public function save()
    {
        ...
        $this->response->html($this->template->layout('task_new', array(
			...
			'releases_list' => $this->release->getList($values['project_id']),
            'date_format' => $this->config->get('application_date_format'),
            'date_formats' => $this->dateParser->getAvailableFormats(),
            'menu' => 'tasks',
            'title' => t('New task')
    ...
    public function edit()
    {
        ...
        $params = array(
			...
			'releases_list' => $this->release->getList($task['project_id']),
            'date_format' => $this->config->get('application_date_format'),
            'date_formats' => $this->dateParser->getAvailableFormats(),
            'ajax' => $ajax,
            'menu' => 'tasks',
